...
def get_fmnist_loaders_3channels(n_train, n_val=10000, batch_size_train=None, batch_size=128, seed=0):
...
def get_binary_fmnist_loaders_01(n_train, n_val=2000, batch_size_train=None, batch_size=128, seed=0):
...
def get_binary_fmnist_loaders_24(n_train, n_val=2000, batch_size_train=None, batch_size=128, seed=0):
...
def get_binary_fmnist_loaders_24_3channels(n_train, n_val=2000, batch_size_train=None, batch_size=128, seed=0):
