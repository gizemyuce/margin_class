...
def margin_classifiers_perf(d=1000,n=100,approx_tau=1, SNR=10, n_test=1e4, s=None, random_flip_prob=0, l1=True, l2=False, mixture=False, outlier_strength=100, estimator_type = 'l1-avg-intp', seed=0):
    ...
    if estimator_type == 'l1-avg-intp':
        w = l1_average_interp(z1s, z2s, linear_program=True)
    elif estimator_type == 'l2-avg-intp':
        w = l2_average_interp(z1s, z2s)
    elif estimator_type == 'l2-min':
        w = l2_min_margin(xs, ys)
    elif estimator_type == 'l1-min':
        w = l1_min_margin(xs, ys)
    elif estimator_type == 'l1-avg-cf':
        w = min_l1_average_cf(z1s, z2s)
    elif estimator_type == 'l2-avg-cf':
